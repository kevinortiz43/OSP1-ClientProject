...
//imported controllers for ai chatbot
import { parseNaturalLanguageQuery } from "../controllers-Kevin/naturalLanguageController";
import { queryOpenAI } from "../controllers-Kevin/openaiController";
import { queryStarWarsDatabase } from "../controllers-Kevin/databaseController";
...
router.post(
  ...
  (req, res) => {
    return res.json({
      data: res.locals.databaseQueryResult,
    });
  },
);
