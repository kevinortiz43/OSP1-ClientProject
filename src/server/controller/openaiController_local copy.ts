...
//   // Try fastSearch for ALL short queries (under 7 words)
//   return query.split(" ").length < 7;
// }
...
//  * - to_tsvector/to_tsquery provides proper PostgreSQL full-text search
...
//     console.log("AI path: Generating SQL...");
//     console.log("naturalLanguageQuery value:", naturalLanguageQuery); 
// console.log("Type of naturalLanguageQuery:", typeof naturalLanguageQuery);

//     const startTime = Date.now();

//     /**
//      * IMPORTANT: The AI service now uses hardcoded SQL DDL schema.
//      * We only pass the question - schemaDescription parameter is ignored.
//      * The service has its own schemaDDL constant with proper quoted identifiers.
//      */
//     const sqlQuery = await aiService.textToSQL({
//       question: naturalLanguageQuery, 
//       schemaDescription: "", // Not used - kept for interface compatibility
//       categories: [],
//       instructions: ''
//     });
