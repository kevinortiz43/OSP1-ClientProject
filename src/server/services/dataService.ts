...
export const dataService = {
  ...
  async getTeams() {
    ...
    setCache(CacheKeys.TEAMS_ALL, data, SEARCH_CACHE_TTL);
  ...
  async getControls() {
    ...
    const data = result.rows;
    setCache(CacheKeys.CONTROLS_ALL, data, SEARCH_CACHE_TTL);
    return { data, source: 'database' };
  },
  ...
  async getFaqs() {
    ...
    const data = result.rows;
    setCache(CacheKeys.FAQS_ALL, data, SEARCH_CACHE_TTL);
    return { data, source: 'database' };
  },
